...
```javascript
let someObject = {
  trainer: "Stojancho Jefremov",
  assistant: "Tosho Todorovski",
  students: [
    "Bob",
    "Samantha",
    "Chris",
...
##### Fetch
```javascript
fetch('https://raw.githubusercontent.com/sedc-codecademy/skwd8-04-ajs/master/g6/Class03/students.json')
